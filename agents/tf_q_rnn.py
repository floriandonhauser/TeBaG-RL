# Straight up nicked from tf_agents q_rnn_network.py
...
# MAX: Changed to custom LSTM Encoder Network
from agents.tf_lstm_encoding import LSTMEmbeddingNetwork


@gin.configurable
class QRnnEmbNetwork(LSTMEmbeddingNetwork):
    ...
    def __init__(
        ...
        super(QRnnEmbNetwork, self).__init__(
