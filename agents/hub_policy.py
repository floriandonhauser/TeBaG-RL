...
embedding_small_url = "https://tfhub.dev/google/nnlm-en-dim50-with-normalization/2"
tfhub_handle_encoder_url = (
    "https://tfhub.dev/tensorflow/small_bert/bert_en_uncased_L-2_H-128_A-2/1"
)
tfhub_handle_preprocess_url = "https://tfhub.dev/tensorflow/bert_en_uncased_preprocess/3"
...
class HubPolicyBert(network.Network):
    ...
    def __init__(
        ...
        self.bert_preprocess_model = hub.KerasLayer(
            tfhub_handle_preprocess_url,
            input_shape=[],
            dtype=tf.string,
        )
        self.bert_model = hub.KerasLayer(tfhub_handle_encoder_url, trainable=True)
...
class HubPolicySmall(network.Network):
    """Policy for DQN agent utilizing pre-trained NNLM embedding into FC layers."""
